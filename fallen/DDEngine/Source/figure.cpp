        ...
        do {
            ...
            for (; iOuterFaceNum < iOuterFaceEnd; iOuterFaceNum++) {
                ...
                if (iMatNum != 0) {
                    ...
                    ASSERT(pPrimObj->pMaterials != nullptr);
                    if (pPrimObj->pMaterials == nullptr) {
