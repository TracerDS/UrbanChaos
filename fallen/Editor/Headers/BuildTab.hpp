...
class MapBlock {
   ...
   public:
    MapBlock();
    ~MapBlock();
    void Cut(std::int32_t x, std::int32_t y, std::int32_t w, std::int32_t h, std::int32_t rooftop);
    void Paste(std::int32_t x, std::int32_t z, std::int32_t flags, std::int32_t rooftop);
    void Allocate(std::int32_t w, std::int32_t h);
    void Rotate(std::int32_t dir);
    void Free();
    inline std::int32_t GetWidth() { return (Width); }
    inline std::int32_t GetDepth() { return (Depth); }
...
class BuildTab : public ModeTab {
   ...
   public:
    ...
    std::int32_t ClickInVertexStoreyList(std::int32_t building, std::int32_t storey_index, std::int32_t w, std::int32_t h, MFPoint *mouse_point, std::int32_t flags);
    std::int32_t ClickInVertex(std::int32_t x, std::int32_t y, std::int32_t w, std::int32_t h, MFPoint *mouse_point, std::int32_t flags);
