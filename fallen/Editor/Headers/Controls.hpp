...
class CStaticText : public Control {
   ...
   public:
    ...
    void DrawControl();
    inline char *SetString1(char *the_string) {
        strncpy(String1, the_string, EDIT_TEXT_LENGTH);
        String1[EDIT_TEXT_LENGTH - 1] = 0;
        return String1;
    }
    inline char *SetString2(char *the_string) {
...
class CEditText : public Control {
   ...
   public:
    ...
    inline char *SetEditString(char *the_string) {
...
class CHSlider : public Control {
   ...
   public:
    ...
    inline void SetValueRange(std::int32_t min, std::int32_t max) {
        MinValue = min;
        MaxValue = max;
        SetupDrag();
    }
