...
#define SET_TEXTURE_COORDS                                                              \
    texture_x = TextureX;                                                               \
    if (texture_x > (256 - (1 << TextureZoom))) texture_x = (256 - (1 << TextureZoom)); \
    texture_y = TextureY;                                                               \
    if (texture_y > (256 - (1 << TextureZoom))) texture_y = (256 - (1 << TextureZoom));
...
MenuDef2 mode_menu[] =
    {
        {"Palette"}, {"Textures"}, {"planar"}, {"ANIMS"}, {"PLAN VIEW"}, {"Style Paint"}, {"Style Def"}, {"Inside Style Def"}, {"PSX Alt"}, {"!"}};
