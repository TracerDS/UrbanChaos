...
void do_quad_clip_list(std::int16_t face, std::int32_t p0, std::int32_t p1, std::int32_t p2, std::int32_t p3) {
    ...
    } else if (global_res[p0].X > edit_info.SelectRect.GetLeft() &&
...
rot X 1 0 0 0 cx sx 0 - sx cx
    ...
    sy - sz cz 0 sxsycz - cxsz sxsysz + cxcz sxcy 0 0 1 cxsycz + sxsz cxsysz - sxcz cxcy
                                      ...
                                      sxsz = G
                                             ...
                                             sxcz = H
                                                 cxcy = I
                                                     ...
                                                     czcy = A
                                                         cysz = B - sy = C sxcz * (-C) - cxsz = D sx * (-C) sz + cxcz = E
                                                                                                    sxcy = F
                                                                                                           cx(-C) cz +
                                                                                                           sxsz = G
                                                                                                                  cx(-C) sz -
...
float det33(float a1, float a2, float a3, float b1, float b2, float b3, float c1, float c2, float c3) {
    ...
    ans = a1 * det22(b2, b3, c2, c3) - b1 * det22(a2, a3, c2, c3) + c1 * det22(a2, a3, b2, b3);
