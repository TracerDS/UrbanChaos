...
#include "GEditEnemySetup.h"
#include "GEditItemSetup.h"
#include "GEditMission.h"
#include "GEditPlayerSetup.h"
#include "GEditTriggerSetup.h"
#include "GEditCameraSetup.h"
#include "PlatformSetup.h"
#include "GEditCamTargetSetup.h"
            ...
            while (current_ep) {
                ...
                if (dist < (20 << 8)) {
                    ...
                    if (WaypointUses[ep_ptr->TriggeredBy] & WPU_DEPEND) {
                        ...
                        if ((!lines_mode) || ((lines_mode == 1) && ((ep_ptr == selected_ep) || (ep_ptr == hilited_ep))) || ((lines_mode == 2) && ((ep_ptr == selected_ep) || (ep_ptr == hilited_ep) || (targ == hilited_ep) || (targ == selected_ep)))) {
                            if (ep_ptr->EPRef) {
