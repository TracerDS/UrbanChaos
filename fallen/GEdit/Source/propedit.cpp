...
void TimeLine::Del(std::uint16_t index) {
	TLEntry *entry;
...
void TimeLine::MarkEntry(std::uint16_t index, std::uint16_t start, std::uint16_t length, std::uint8_t which) {
	TLEntry *entry;
	std::int32_t c0;
	std::uint8_t v;
