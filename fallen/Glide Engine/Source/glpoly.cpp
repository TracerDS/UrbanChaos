...
float POLY_signed_dist_left(void* pp) {
    return ((POLY_Point*) pp)->X;
}
float POLY_signed_dist_right(void* pp) {
    return 640.0F - ((POLY_Point*) pp)->X;
}
float POLY_signed_dist_top(void* pp) {
    return ((POLY_Point*) pp)->Y;
}
float POLY_signed_dist_bottom(void* pp) {
    return 480.0F - ((POLY_Point*) pp)->Y;
}
