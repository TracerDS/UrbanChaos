...
typedef ALCcontext* (ALC_APIENTRY*PFNALCGETTHREADCONTEXTPROC)() ALC_API_NOEXCEPT17;
#ifdef AL_ALEXT_PROTOTYPES
ALC_API ALCboolean  ALC_APIENTRY alcSetThreadContext(ALCcontext *context) ALC_API_NOEXCEPT;
ALC_API ALCcontext* ALC_APIENTRY alcGetThreadContext() ALC_API_NOEXCEPT;
#endif
#endif
...
typedef void (AL_APIENTRY*LPALREQUESTFOLDBACKSTOP)() AL_API_NOEXCEPT17;
#ifdef AL_ALEXT_PROTOTYPES
...
typedef void (AL_APIENTRY*LPALDEFERUPDATESSOFT)() AL_API_NOEXCEPT17;
typedef void (AL_APIENTRY*LPALPROCESSUPDATESSOFT)() AL_API_NOEXCEPT17;
#ifdef AL_ALEXT_PROTOTYPES
...
typedef void (AL_APIENTRY*LPALPOPDEBUGGROUPEXT)() AL_API_NOEXCEPT17;
